...
void matchearProfesional(const char* matricula)
{
    ...
    for(int i = 0; i < cantidad; i++)
    {
        ...
        if(strcmp(matricula, profesionales[i].getMatricula()) == 0&& !(profesionales[i].getEliminado()))
        {

            std::cout <<"Profesional: " << profesionales[i].getApellido() << " " << profesionales[i].getNombre() << std::endl;
...
void matchearPaciente(const char* dni)
{
    ...
    for(int i = 0; i < cantidad; i++)
    {
        ...
        if(strcmp(dni, pacientes[i].getDni()) == 0&& !(pacientes[i].getEliminado()))
        {

            std::cout <<"Paciente: " << pacientes[i].getApellido() << " " << pacientes[i].getNombre() << std::endl;
...
void buscarTurnoPorFecha()
{
    ...
    ///Inicio ordenamiento por hora ascendente
    for (int i = 0; i < cantidad - 1; i++)
    {
        for (int j = 0; j < cantidad - 1; j++)
        {
            int horario1 = turnos[j].getHoraTurno();
            int horario2 = turnos[j + 1].getHoraTurno();
    ...
    for(int i = 0; i < cantidad; i++)
    {
        ...
        if(fechaTurno == turnos[i].getFecha() && turnos[i].getEliminado() == false)
        {

            matchearProfesional(turnos[i].getMatricula());
            turnos[i].mostrar();
            matchearPaciente(turnos[i].getDniPaciente());
            std::cout<<"--------------------------------------";
            std::cout<<"\n";
            encontrado = true;
        }
    ...
    if(!encontrado)
    {
        ...
        std::cout<<"No se encontraron turnos para la fecha ingresada";
        std::cout<<"\n";
    }
...
void buscarTurnoPorDni()
{
    ...
    for(int i = 0; i < cantidad; i ++)
    {
        ...
        if (strcmp(turnos[i].getDniPaciente(), dniPaciente) == 0 && !turnos[i].getEliminado())
        {
    ...
    if(!encontrado)
    {
        ...
        std::cout<<"No se encontraron turnos para el DNI ingresado";
        std::cout<<"\n";
    }
...
void buscarTurnoPorMatricula()
{
    ...
    do
    {
        ...
        existeP = estaProfesionalActivo(matricula);

        if(!existeP)
        {
            std::cout << "No encontramos el profesional con esa matricula " << std::endl;
        }
    }
    while(!existeP);
    ...
    for(int i = 0; i < cantidad; i ++)
    {
        ...
        if (strcmp(turnos[i].getMatricula(), matricula) == 0 && !turnos[i].getEliminado())
        {
    ...
    if(!encontrado)
    {
        ...
        std::cout<<"No se encontraron turnos este profesional";
        std::cout<<"\n";
    }
...
void buscarTurnoPorMatriculaYFecha()
{
    ...
    for(int i = 0; i < cantidad; i++)
    {
        ...
        if(fechaTurno == turnos[i].getFecha() && turnos[i].getEliminado() == false && strcmp(turnos[i].getMatricula(), matricula) == 0)
        {
...
void mostrarTodosTurnosActivos()
{
    ...
    for(int k = 0; k < cantidad; k++)
    {
...

        {
            ...
            matchearProfesional(turnos[k].getMatricula());
            turnos[k].mostrar();
            matchearPaciente(turnos[k].getDniPaciente());
            std::cout<<"--------------------------------------------------------";
            std::cout<<"\n";
            encontrado = true;
    ...
    if(!encontrado)
    {
        ...
        std::cout<<"No se encontraron turnos";
        std::cout<<"\n";
    }
    delete [] turnos;
}
