...
int main()
{
    int opcion, opcionPaciente, opcionBuscarPaciente, opcionProfesional, opcionBuscarProfesional, opcionTurno, opcionEspecialidad, opcionInforme, opcionBuscarTurno;
    char salir;
    Paciente p1;
    Profesional pr1;
