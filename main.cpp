...
int menuPrincipal()
{
    ...
    return opcion = pedirIntValido("Ingrese una opcion : ");

}
void menuPaciente()
{
    int opcionPaciente, opcionBuscarPaciente;
...
{
    int opcionProfesional, opcionBuscarProfesional;
    while (true)
    {
        system("cls");
...
void menuTurnos()
{
    int opcionTurno, opcionBuscarTurno;
    ...
    while (true)
    {
        ...
        cout << "5 - LISTAR TURNOS" << endl;
        cout << "6 - RESTAURAR TURNOS" << endl;
        cout << "0 - VOLVER AL MENU PRINCIPAL" << endl << endl;
        ...
        case 2:
            system("cls");
            cout << "\033[4m";  // Comienza subrayado
            cout << "BUSCAR TURNO" << endl<<endl;
            cout << "\033[0m";  // Detiene subrayado

            cout << "1 - POR PACIENTE" << endl;
            cout << "2 - POR PROFESIONAL" << endl;
            cout << "3 - FECHA" << endl;
            cout << "0 - VOLVER AL MENU PRINCIPAL" << endl<< endl;
            opcionBuscarTurno = pedirIntValido("Ingrese una opcion: ");
